...
class MainModule extends \yii\base\Module implements ModuleInterface
{
    ...
    public static function getMenuItems()
    {
        ...
        array_push($items, ['label' => 'Carrera de Grado', 'url' => ['alumno/carreras'], 'icon' => 'fa fa-building','options' =>['class'=>'tarjetas'],  'active' => \Yii::$app->controller->id == 'alumno']);
        ...
        array_push($items, ['label' => 'Libro de Graduados', 'url' => ['alumno/graduados'], 'icon' => 'fa fa-building','options' =>['class'=>'tarjetas'],  'active' => \Yii::$app->controller->id == 'alumno']); 
        return $items;
    }
